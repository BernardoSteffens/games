...
| :---------: | :-------------- | :---------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------- |
|    **GET**  | `/games/`       | Lista todos os jogos, pode ser usados vários parâmetros de filtro ou ordenação (`?genero=, ?plataforma=, ?nome=, ?ordenarPorNomeDesc=, ?ordenarPorRatingAsc=, ?ordenarPorRatingDesc=`).| `200 OK`, `204 NO CONTENT`, `500 INTERNAL SERVER ERROR`                                 |
